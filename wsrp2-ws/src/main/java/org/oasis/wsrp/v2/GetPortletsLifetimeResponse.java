...
/**
 * <p>Java class for getPortletsLifetimeResponse complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="portletLifetime" type="{urn:oasis:names:tc:wsrp:v2:types}PortletLifetime" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "getPortletsLifetimeResponse", propOrder = {
    "portletLifetime",
    "failedPortlets",
    "resourceList",
    "extensions"
...
public class GetPortletsLifetimeResponse {
    ...
    /**
     * Gets the value of the portletLifetime property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the portletLifetime property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPortletLifetime().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PortletLifetime> getPortletLifetime() {
        if (portletLifetime == null) {
            portletLifetime = new ArrayList<PortletLifetime>();
        }
