...
package org.wsrp.wss.credentials;
...
public class HTTPSessionCredentialsAccessor implements CredentialsAccessor
{
    ...
    * {@link org.gatein.wci.security.Credentials#CREDENTIALS} and current HTTP request is bound to {@link org.gatein.wsrp.servlet.ServletAccess} thread-local.
    *
    * @return credentials
    */
   @Override
