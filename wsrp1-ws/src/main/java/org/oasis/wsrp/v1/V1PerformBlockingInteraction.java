...
public class V1PerformBlockingInteraction {
    ...
    @XmlElement(required = true)
    protected V1InteractionParams interactionParams;
     ...
     * @return
     *     possible object is
     *     {@link V1InteractionParams }
     *     
     */
    public V1InteractionParams getInteractionParams() {
     ...
     *     
     */
    public void setInteractionParams(V1InteractionParams value) {
