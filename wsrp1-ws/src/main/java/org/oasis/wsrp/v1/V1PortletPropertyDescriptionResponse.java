...
public class V1PortletPropertyDescriptionResponse {

    protected V1ModelDescription modelDescription;
     ...
     *     
     */
    public V1ModelDescription getModelDescription() {
     ...
     *     
     */
    public void setModelDescription(V1ModelDescription value) {
