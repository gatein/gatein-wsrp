...
public class V1ModelDescription {

    protected List<V1PropertyDescription> propertyDescriptions;
    protected V1ModelTypes modelTypes;
     ...
     * {@link V1PropertyDescription }
     * 
     * 
     */
    public List<V1PropertyDescription> getPropertyDescriptions() {
        if (propertyDescriptions == null) {
            propertyDescriptions = new ArrayList<V1PropertyDescription>();
        }
     ...
     *     
     */
    public V1ModelTypes getModelTypes() {
        return modelTypes;
    }
     ...
     *     
     */
    public void setModelTypes(V1ModelTypes value) {
