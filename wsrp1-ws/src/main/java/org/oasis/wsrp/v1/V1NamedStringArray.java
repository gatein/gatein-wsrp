...
public class V1NamedStringArray {

    @XmlElement(name = "NamedString")
    protected List<V1NamedString> namedString;
     ...
     * 
     */
    public List<V1NamedString> getNamedString() {
        if (namedString == null) {
            namedString = new ArrayList<V1NamedString>();
        }
