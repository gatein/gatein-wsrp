...
public class V1SetPortletProperties {
    ...
    @XmlElement(required = true)
    protected V1PropertyList propertyList;
     ...
     *     
     */
    public V1PropertyList getPropertyList() {
        return propertyList;
    }
     ...
     *     
     */
    public void setPropertyList(V1PropertyList value) {
